...
import (
	...
	_ "github.com/lib/pq"
	"github.com/tchenbz/AWTfinal/internal/data"
	"github.com/tchenbz/AWTfinal/internal/mailer"
)
...
func main() {
	...
	flag.StringVar(&settings.db.dsn, "db-dsn", os.Getenv("FINAL_DB_DSN"), "PostgreSQL DSN")
